...
BHV_rotate_lawnmower::BHV_rotate_lawnmower(IvPDomain domain) :
  IvPBehavior(domain)
{
...
bool BHV_rotate_lawnmower::setParam(string param, string val)
{
...
void BHV_rotate_lawnmower::onSetParamComplete()
{
	//postMessage("RUN_STATE","true");
}
...
void BHV_rotate_lawnmower::onHelmStart()
{
}
...
void BHV_rotate_lawnmower::onIdleState()
{
	postMessage("RUN_STATE","true");
}
...
void BHV_rotate_lawnmower::onCompleteState()
{
}
...
void BHV_rotate_lawnmower::postConfigStatus()
{
}
...
void BHV_rotate_lawnmower::onIdleToRunState()
{
}
...
void BHV_rotate_lawnmower::onRunToIdleState()
{
}
...
IvPFunction* BHV_rotate_lawnmower::onRunState()
{
	bool ok1, ok2;
	m_osx = getBufferDoubleVal("NAV_X", ok1);//OnNewMail
	m_osy = getBufferDoubleVal("NAV_Y", ok2);
	postMessage("RUN_STATE2","true");
	if(counter==0)
	{
		setting_path();
		counter++;
...
IvPFunction *BHV_rotate_lawnmower::buildFunctionWithZAIC() 
{
...
void BHV_rotate_lawnmower::setting_path()
{
      //Before starting
      ...
      postMessage("A_AFTER",m_information);
	...
	{iter = view_point.erase(iter); iter--;  continue;}
...
void BHV_rotate_lawnmower::calculate_distance()
{
